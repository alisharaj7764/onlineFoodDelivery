...
<body>
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								<a class="dropdown-item" href="category/addcategory">Add Category</a>
								<a class="dropdown-item" href="item/modifyitem">Update Category</a>
								<a class="dropdown-item" href="item/deleteitem">Remove Category</a>
								<a class="dropdown-item" href="item/listitem">View All Category</a>
							</div>
						</li> -->
					</ul>
				</div>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 100px;padding: 160px;height: 300px;">
		<div class="row">
			<div class="alert alert-success">Category Added Successfully</div>
			<%
			Category category = (Category)request.getAttribute("category");
			out.println("<p>&emsp;<a href=\"http://localhost:5000/restaurant/viewrestaurant?restaurantid=" +category.getRestaurant().getRestaurantId() +"\"><button style=\"height:30px;width:150px\">View_Restaurant</button></a></p>");
            %>  
		  </div>
	</div>
