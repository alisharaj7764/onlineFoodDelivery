...
<body>
    ...
    <div class="container" style="margin-top: 0px;margin-bottom: 300px;padding-top: 0px;padding-bottom: 800px;height: 300px;">
        <table class="table table-striped table-inverse table-responsive">
          <thead class="thead-inverse">
            <tr>
              <%
              out.println("<th><h1 class=\"m-b-20\"; style=\"font-size:30px;font-family:Serif;\">Category</h1></th>");
              %>
              <th></th>
          ...
          <tbody>
            ...
            List<Category> categorys = (List<Category>) request.getAttribute("categorys");
                for(Category category : categorys){
                  out.println("<tr>");
                  out.println("<td scope=\"row\"><h1 class=\"m-b-20\"; style=\"font-size:20px;font-family:Serif;\">"+category.getCategoryName()+"</h1></td><br>");
                  out.println("<td><a href=\"http://localhost:5000/item/listitem?categoryId=" +category.getCategoryId()+"\"><button>View</button></a></td>");
				  out.println("<td><a href=\"http://localhost:5000/category/fetchcategory?categoryId=" +category.getCategoryId()+"\"><button>Modify</button></a></td>");
				  out.println("<td><a href=\"http://localhost:5000/category/fetchdeletecategory?categoryId=" +category.getCategoryId()+"\"><button>Delete</button></a></td>");
				  out.println("<td><a href=\"http://localhost:5000/item/additem?restaurantId=" +category.getRestaurant().getRestaurantId()+ "&&categoryId=" +category.getCategoryId()+"\"><button>Add Item</button></a></td>");
                  out.println("</tr>");
                  }
            %>  
