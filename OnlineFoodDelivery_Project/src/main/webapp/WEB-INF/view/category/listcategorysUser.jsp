...
<body>
    ...
    <div class="container" style="margin-top: 0px;margin-bottom: 700px;padding-top: 30px;height: 300px;">
          ...
          <tbody>
            ...
            List<Category> categorys = (List<Category>) request.getAttribute("categorys");
                for(Category category : categorys){
                  ...
                  out.println("<td><a href=\"http://localhost:5000/item/listitemCUser?categoryId=" +category.getCategoryId()+"\"><button>View</button></a></td>");
                  out.println("</tr>");
                  }
            %>  
