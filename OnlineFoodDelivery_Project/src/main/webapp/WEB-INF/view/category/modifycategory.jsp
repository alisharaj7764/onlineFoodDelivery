          ...
          <tbody>
            <%
              ...
              for(Category category : categorys){
                out.println("<tr>");
                out.println("<td scope=\"row\">"+category.getCategoryId()+"</td>");
                out.println("<td scope=\"row\">"+category.getCategoryName()+"</td>");
                out.println("<td><a href=\"http://localhost:5000/category/fetchcategory?categoryid=" +category.getCategoryId() +"\"><button>Update Category</button></a></td>");
                out.println("</tr>");
              }
            %>  
          </tbody>
