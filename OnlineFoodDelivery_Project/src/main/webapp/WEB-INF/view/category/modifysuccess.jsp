...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 20px;padding: 140px;height: 300px;">
		<div class="row">
			...
			out.println("<p>&emsp;<a href=\"http://localhost:5000/category/listcategory?restaurantId=" +category.getRestaurant().getRestaurantId() +"\"><button style=\"height:30px;width:150px\">View_Category</button></a></p>");
            %>  
		  </div>
	</div>
