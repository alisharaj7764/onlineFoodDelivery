...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 400px;padding: 150px;height: 300px;">
          ...
          <tbody>
            <%
              ...
              for(Restaurant restaurant : restaurants){
                out.println("<tr>");
                out.println("<td scope=\"row\">"+restaurant.getRestaurantId()+"</td>");
                out.println("<td scope=\"row\">"+restaurant.getRestaurantName()+"</td>");
                out.println("<td><a href=\"http://localhost:5000/restaurant/viewrestaurantmodify?restaurantid=" +restaurant.getRestaurantId() +"\"><button>View</button></a></td>");
                out.println("<td><a href=\"http://localhost:5000/restaurant/fetchrestaurant?restaurantid=" +restaurant.getRestaurantId() +"\"><button>Update Restaurant</button></a></td>");
                out.println("</tr>");
              }
            %>  
          </tbody>
