          ...
          <tbody>
            <%
              ...
              for(Restaurant restaurant : restaurants){
                ...
                out.println("<td><a href=\"http://localhost:5000/restaurant/viewrestaurantdelete?restaurantid=" +restaurant.getRestaurantId() +"\"><button>View</button></a></td>");
                out.println("<td><a href=\"http://localhost:5000/restaurant/fetchfordeleterestaurant?restaurantid=" +restaurant.getRestaurantId() +"\"><button>Delete Restaurant</button></a></td>");
                out.println("</tr>");
              }
            %>  
          </tbody>
