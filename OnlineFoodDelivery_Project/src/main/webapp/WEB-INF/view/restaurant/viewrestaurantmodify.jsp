...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 330px;padding: 150px;height: 300px;">
		<div class="row">
			<form:form action="/restaurant/modifyrestaurant" method="get" modelAttribute="restaurant">

               <div class="form-group">
                <label for="restaurantId">RestaurantId</label>
                <input type="text" disabled value="${restaurant.restaurantId}" class="form-control" id="restaurantId"/>
              </div>
