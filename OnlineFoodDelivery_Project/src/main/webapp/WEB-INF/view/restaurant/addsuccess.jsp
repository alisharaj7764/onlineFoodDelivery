...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 100px;padding-top: 160px;height: 300px;">
		<div class="row">
			<div class="alert alert-success">Restaurant Added Successfully</div>
			<%out.println("<tr>");
				out.println("<td>&emsp;<a href=\"http://localhost:5000/restaurant/addrestaurant\"><button>Add Again</button></a></td>");
				out.println("</tr>");
				%>
		</div>
	</div>
