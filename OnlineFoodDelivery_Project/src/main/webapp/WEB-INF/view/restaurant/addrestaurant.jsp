...
<body>
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle active" href="#" id="dropdown-a" data-toggle="dropdown">Restaurant</a>
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								...
								<a class="dropdown-item" href="restaurant/listrestaurant">View Restaurant</a>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 380px;padding-top: 160px;padding-bottom: 400px;height: 300px;">
		<div class="row">
			<form:form action="/restaurant/addrestaurant" method="post" modelAttribute="restaurant">
			  ...
			  <div class="form-group">
				...
				<form:input path="location.address" class="form-control" id="location.address"/>
			  </div>

			  <div class="form-group">
				<label for="location.city">City</label>
				<form:input path="location.city" class="form-control" id="location.city"/>
			  </div>

			  <div class="form-group">
				<label for="location.pincode">PIN Code</label>
				<form:input path="location.pincode" class="form-control" id="location.pincode"/>
			  </div>
