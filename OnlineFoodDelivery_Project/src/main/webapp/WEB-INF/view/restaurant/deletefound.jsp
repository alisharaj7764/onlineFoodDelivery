...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 240px;padding: 150px;padding-bottom: 450px;height: 300px;">
		<div class="row">
			<form:form action="/restaurant/deleterestaurantprocess" method="post" modelAttribute="restaurant">
			   ...
			   <form:hidden path = "location.addressId" value = "${restaurant.location.addressId}" />
			  ...
			  <div class="form-group">
				...
				<form:input path="location.address" value="${restaurant.location.address}" class="form-control" id="location.address"/>
			  </div>

			  <div class="form-group">
				<label for="location.city">City</label>
				<form:input path="location.city" value="${restaurant.location.city}" class="form-control" id="location.city"/>
			  </div>

			  <div class="form-group">
				<label for="location.pincode">PINCode</label>
				<form:input path="location.pincode" value="${restaurant.location.pincode}" class="form-control" id="location.pincode"/>
			  </div>
