		...
		<div class="row">
			<form:form action="/user/addUser" method="post" modelAttribute="user">
              ...
              <div class="form-group">
				...
				<form:input path="addressUser.buildingName" class="form-control" id="buildingName"/>
			  </div>
	  
			  <div class="form-group">
				<label for="streetNo">Street Number</label>
				<form:input path="addressUser.streetNo" class="form-control" id="streetNo"/>
			  </div>

			  <div class="form-group">
				<label for="city">City</label>
				<form:input path="addressUser.city" class="form-control" id="city"/>
			  </div>

              <div class="form-group">
				<label for="state">State</label>
				<form:input path="addressUser.state" class="form-control" id="state"/>
			  </div>
              <div class="form-group">
				<label for="country">Country</label>
				<form:input path="addressUser.country" class="form-control" id="country"/>
			  </div>
              <div class="form-group">
				<label for="pincode">Pincode</label>
				<form:input path="addressUser.pincode" class="form-control" id="pincode"/>
			  </div>
              <div class="form-group">
