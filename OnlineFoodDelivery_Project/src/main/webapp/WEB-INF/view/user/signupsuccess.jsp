...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 200px;padding-left:50px;padding-top: 160px;height: 300px;">
		<div class="row">
			<div class="alert alert-success">You have Successsfully signed up</div>

	

			<form:form action="/login/customerlogin" method="get" style="padding-left:50px;">
