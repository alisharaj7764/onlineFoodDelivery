			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="http://localhost:5000/restaurant/addrestaurant">Add Restaurant</a></li>
						...
						<li class="nav-item dropdown">
						 ...
						 <li class="nav-item"><a class="nav-link" href="http://localhost:5000/category/listcategorys">Categories</a></li> 
					</ul>
				</div>
			</div>
		</nav>
          ...
          <tbody>
            ...
            <%
              ...
              for(Restaurant restaurant : restaurants){
                ...
                out.println("<tr>");
                out.println("<p><a href=\"http://localhost:5000/restaurant/viewrestaurant?restaurantid=" +restaurant.getRestaurantId() +"\"><button style=\"height:50px;width:800px\"><h1 class=\"m-b-20\"; style=\"font-size:30px;font-family:Serif;\">"+restaurant.getRestaurantName()+"</h1></button></a></p>");
                out.println("<br>");
                out.println("<br>");
                out.println("</div>");
                out.println("</div>");
