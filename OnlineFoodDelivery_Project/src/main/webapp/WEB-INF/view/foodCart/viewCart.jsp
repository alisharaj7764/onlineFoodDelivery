...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 900px;padding-top: 160px;padding-left:150px;padding-bottom: 500px;height: 300px;">
        <table class="table table-striped table-inverse table-responsive">
          <thead class="thead-inverse">
            <tr>
			  ...
			  out.print("<p><a class=\"btn btn-primary\" style:\"margin-left:10%; \" href=\"http://localhost:5000/item/listitemsUser?restaurantId=" +restaurant.getRestaurantId()+ "\">Add More</a></p>");
              OrderDetails details=(OrderDetails)request.getAttribute("orderDetails");
              out.print("<p><a class=\"btn btn-primary\" style:\"margin-left:10%; \" href=\"http://localhost:5000/foodCart/orderDetails?orderid=" +details.getOrderId()+ "\">Order details</a></p>");
            %>
          ...
          <tbody>
            ...
            FoodCart cart=(FoodCart)request.getAttribute("cart");
              ...
              for(Item item : items){
				...
				out.println("<td><a href=\"http://localhost:5000/foodCart/deleteItem?itemid=" +item.getItemId() +"\"><button>Delete</button></a></td>");
                out.println("</tr>");
              }
