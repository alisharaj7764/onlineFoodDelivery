...
<body>
	...
	<div class="row" style="margin-top: 0px;margin-bottom: 500px;padding-top: 180px;padding-left: 100px;padding-bottom: 2100px;height: 300px;">
		<div class="column">
			<%
			  List<Item> items = (List<Item>) request.getAttribute("items");
			  for(Item item : items){
				
			   out.println("<img src=\"../../images/"+item.getItemName()+".jpg\" width=\"300px\" height=\"250px\" ><a class=\"m-b-20\"; style=\"font-size:30px;font-family:Serif;color:black;\">&ensp;"+item.getItemName()+"&emsp;Rs."+item.getCost()+"&emsp;</a><a href=\"http://localhost:5000/login/customerlogin\"><button style=\"height:40px;width:150px;font-size:20px;background-color:crimson;border-color:white;color:white;\">Add To Cart</button></a><br><br>");
