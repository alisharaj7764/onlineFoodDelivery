...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 330px;padding: 120px;padding-top: 150px;height: 300px;">
        <div class="row">
		
          <form:form action="/item/listitems" method="get" modelAttribute="item">
