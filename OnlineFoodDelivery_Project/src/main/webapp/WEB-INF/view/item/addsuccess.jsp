...
<body>
	...
	<div class="container" style="margin-top: 0px;margin-bottom: 100px;padding: 160px;height: 300px;">
		<div class="row">
			...
			out.println("<p>&emsp;<a href=\"http://localhost:5000/restaurant/viewrestaurant?restaurantid=" +item.getRestaurant().getRestaurantId() +"\"><button style=\"height:30px;width:150px\">View_Restaurant</button></a></p>");
            out.println("<p>&emsp;<a href=\"http://localhost:5000/category/listcategorys\"><button style=\"height:30px;width:150px\">View_Category</button></a></p>");
