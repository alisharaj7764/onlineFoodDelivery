...
<body>
	...
	<div class="row" style="margin-top: 0px;margin-bottom: 200px;padding-top: 160px;padding-left: 100px;padding-bottom: 2000px;height: 300px;">
		<div class="column">
			<%
			  List<Item> items = (List<Item>) request.getAttribute("items");
			  for(Item item : items){
				
			   out.println("<img src=\"../../images/"+item.getItemName()+".jpg\" width=\"300px\" height=\"250px\" ><a class=\"m-b-20\"; style=\"font-size:30px;font-family:Serif;color:black;\">&ensp;"+item.getItemName()+"&emsp;Rs."+item.getCost()+"&emsp;</a><a href=\"http://localhost:5000/item/fetchdeleteitem?itemid=" +item.getItemId() +"\"><button style=\"height:40px;width:80px;font-size:20px;background-color:crimson;border-color:white;color:white;\">Delete</button></a>&emsp;<a href=\"http://localhost:5000/item/fetchitem?itemid=" +item.getItemId() +"\"><button style=\"height:40px;width:80px;font-size:20px;background-color:crimson;border-color:white;color:white;\">Modify</button></a><br><br>");
