...
<body>
	...
	<div class="row" style="margin-top: 0px;margin-bottom: 200px;padding-top: 160px;padding-left: 100px;padding-bottom: 1000px;height: 300px;">
		<div class="column">
			<%
			  List<Item> items = (List<Item>) request.getAttribute("items");
			  for(Item item : items){
				
			   out.println("<img src=\"../../images/"+item.getItemName()+".jpg\" width=\"300px\" height=\"250px\" ><a class=\"m-b-20\"; style=\"font-size:30px;font-family:Serif;color:black;\">&ensp;"+item.getItemName()+"&emsp;Rs."+item.getCost()+"</a><br><br>");
