	...
	<div class="container" style="margin-top: 0px;margin-bottom: 20px;padding: 140px;height: 300px;">
		<div class="row">
		  ...
		  <%
			...
			out.println("<p><a href=\"http://localhost:5000/restaurant/viewrestaurant?restaurantid=" +item.getRestaurant().getRestaurantId() +"\"><button style=\"height:30px;width:150px\">View_Item</button></a></p>");
